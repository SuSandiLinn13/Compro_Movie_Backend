...
export default function Home() {
  ...
  if (loading) return <p style={{ color: "#fff", margin: "20px" }}>Loading...</p>;
  if (error) return <p style={{ color: "red", margin: "20px" }}>Failed to load data.</p>;
