...
//   return (
//     <Box sx={{ maxWidth: 1200, mx: 'auto', mt: 12, px: 3, display: 'flex', flexWrap: 'wrap', gap: 4 }}>
...
//           color="error"
//           sx={{ width: '70%' }}
//           onClick={() => window.open('#', '_blank')} // replace '#' with youtube link later
//         >
//           Watch Now
//         </Button>
//       </Box>
...
//           ))}
//           <Chip label={`Released: ${movie.released_date || 'Unknown'}`} />
//         </Box>
